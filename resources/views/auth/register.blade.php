...
<div class="flex justify-center">
    <div class="w-6/12 bg-white p-6 rounded-lg">
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="mb-4">
                <label for="password_confirmation" class="">Please confirm your password</label>
                <input type="password" name="password_confirmation" id="password_confirmation"
                    placeholder="secretpassword again"
                    class="bg-gray-100 border-2 w-full p-4 rounder-lg @error('name') border-red-500 @enderror" value="">
            ...
            <div>
                <button type="submit"
                    class="bg-yellow-500 text-white px-4 py-3 rounded font-medium w-full">Register</button>
            </div>
        </form>
    </div>
</div>
